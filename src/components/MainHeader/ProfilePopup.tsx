...
export const ProfilePopup = () => {
	...
	return (
		<div className=' overflow-hidden absolute bg-gray-800 right-0 w-max flex-col px-2 shadow-xl border border-gray-600 rounded-md py-2 justify-start top-[120%] animate-fadeIn duration-75 z-[10000]'>
			<div>
